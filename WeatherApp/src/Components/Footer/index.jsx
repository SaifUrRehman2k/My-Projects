...
import TomorrowIo from '../../assets/images/tomorrow.io.png'

const Footer = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-gray-700 text-white  box-border w-[100%] h-40em md:h-[18em] mt-20 py-8 px-12'>
      ...
      <div className='flex flex-col flex-wrap justify-between w-[100%] md:w-[60%] h-[50%] md:h-[100%]'>
        ...
        <img className='w-[128px] self-end'  src={TomorrowIo} alt="" />
      </div>
    </div>
  )
}
